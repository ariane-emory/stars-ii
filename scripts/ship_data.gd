...
var ship_configs: Dictionary = {
	"Alpine Cruiser": ShipConfig.new("Alpine Cruiser", "res://glb/Alpine Cruiser.glb", Vector3(0, -90, 0), 1.5625),
	...
	"Barricade Frigate": ShipConfig.new("Barricade Frigate", "res://glb/Barricade Frigate.glb", Vector3(0, 90, 0), 1.375),
	...
	"Fury Fighter": ShipConfig.new("Fury Fighter", "res://glb/Fury Fighter.glb", Vector3(0, 90, 0), 0.792),
	...
	"Mosquito Fighter": ShipConfig.new("Mosquito Fighter", "res://glb/Mosquito Fighter.glb", Vector3(0, 90, 0), 1.0),
	...
	"Star Skipper Trader": ShipConfig.new("Star Skipper Trader", "res://glb/Star Skipper Trader.glb", Vector3(0, -90, 0), 1.1),
	...
	"Sunbird Fighter": ShipConfig.new("Sunbird Fighter", "res://glb/Sunbird Fighter.glb", Vector3(0, -90, 0), 0.4),
