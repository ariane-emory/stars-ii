...
var ship_configs: Dictionary = {
	"Alpine Cruiser": ShipConfig.new("Alpine Cruiser", "res://glb/Alpine Cruiser.glb", Vector3(0, 90, 0), 1.7578125),
	"Banshee Gunship": ShipConfig.new("Banshee Gunship", "res://glb/Banshee Gunship.glb", Vector3(0, 90, 0), 0.88),
	"Barrier Frigate": ShipConfig.new("Barrier Frigate", "res://glb/Barrier Frigate.glb", Vector3(0, 90, 0), 1.5125),
	...
	"Pacer Gunship": ShipConfig.new("Pacer Gunship", "res://glb/Pacer Gunship.glb", Vector3(0, 90, 0), 1.21),
	...
	"Rimward Freighter": ShipConfig.new("Rimward Freighter", "res://glb/Rimward Freighter.glb", Vector3(0, 90, 0), 0.75),
	...
	"Hedgehog Battleship": ShipConfig.new("Hedgehog Battleship", "res://glb/Hedgehog Battleship.glb", Vector3(0, 90, 0), 1.9602),
