...
var ship_configs: Dictionary = {
	...
	"Type 8 Station": ShipConfig.new("Type 8 Station", "res://glb/Type 8 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 9 Station": ShipConfig.new("Type 9 Station", "res://glb/Type 9 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 10 Station": ShipConfig.new("Type 10 Station", "res://glb/Type 10 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 11 Station": ShipConfig.new("Type 11 Station", "res://glb/Type 11 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 12 Station": ShipConfig.new("Type 12 Station", "res://glb/Type 12 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 14 Station": ShipConfig.new("Type 14 Station", "res://glb/Type 14 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 15 Station": ShipConfig.new("Type 15 Station", "res://glb/Type 15 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 16 Station": ShipConfig.new("Type 16 Station", "res://glb/Type 16 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 17 Station": ShipConfig.new("Type 17 Station", "res://glb/Type 17 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 18 Station": ShipConfig.new("Type 18 Station", "res://glb/Type 18 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 19 Station": ShipConfig.new("Type 19 Station", "res://glb/Type 19 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 20 Station": ShipConfig.new("Type 20 Station", "res://glb/Type 20 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 21 Station": ShipConfig.new("Type 21 Station", "res://glb/Type 21 Station.glb", Vector3(0, 0, 90), 5.0),
	"Type 22 Station": ShipConfig.new("Type 22 Station", "res://glb/Type 22 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 23 Station": ShipConfig.new("Type 23 Station", "res://glb/Type 23 Station.glb", Vector3(0, 0, 90), 5.0),
	"Type 24 Station": ShipConfig.new("Type 24 Station", "res://glb/Type 24 Station.glb", Vector3(0, 0, 0), 5.0),
	"Type 25 Station": ShipConfig.new("Type 25 Station", "res://glb/Type 25 Station.glb", Vector3(0, 0, 0), 5.0),
