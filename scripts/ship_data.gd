...
var ship_configs: Dictionary = {
	...
	"Darkling Fighter": ShipConfig.new("Darkling Fighter", "res://glb/Darkling Fighter.glb", Vector3(0, 90, 0), 0.72),
	...
	"Pinnacle Fighter": ShipConfig.new("Pinnacle Fighter", "res://glb/Pinnacle Fighter.glb", Vector3(0, 90, 0), 1.0),
