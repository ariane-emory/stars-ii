...
var ship_configs: Dictionary = {
	...
	"Bearclaw Frigate": ShipConfig.new("Bearclaw Frigate", "res://glb/Bearclaw Frigate.glb", Vector3(0, 90, 0), 1.3225),
	...
	"Nexion Frigate": ShipConfig.new("Nexion Frigate", "res://glb/Nexion Frigate.glb", Vector3(0, 90, 0), 1.15),
