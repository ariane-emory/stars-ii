...
var ship_configs: Dictionary = {
	...
	"Barricade Frigate": ShipConfig.new("Barricade Frigate", "res://glb/Barricade Frigate.glb", Vector3(0, 90, 0), 2.0625),
	...
	"Pikeman Fighter": ShipConfig.new("Pikeman Fighter", "res://glb/Pikeman Fighter.glb", Vector3(0, 90, 0), 0.648),
	...
	"Guardian Battleship": ShipConfig.new("Guardian Battleship", "res://glb/Guardian Battleship.glb", Vector3(0, 90, 0), 2.2),
