...
var ship_configs: Dictionary = {
	...
	"Nordic Liner": ShipConfig.new("Nordic Liner", "res://glb/Nordic Liner.glb", Vector3(0, 90, 0), 2.05),
	...
	"Quadrant Cruiser": ShipConfig.new("Quadrant Cruiser", "res://glb/Quadrant Cruiser.glb", Vector3(0, 90, 0), 2.181),
