...
var ship_configs: Dictionary = {
	"Alpine Cruiser": ShipConfig.new("Alpine Cruiser", "res://glb/Alpine Cruiser.glb", Vector3(0, 0, 0), 2.184),
	...
	"Bearclaw Frigate": ShipConfig.new("Bearclaw Frigate", "res://glb/Bearclaw Frigate.glb", Vector3(0, 90, 0), 1.571),
	...
	"Bulwark Battleship": ShipConfig.new("Bulwark Battleship", "res://glb/Bulwark Battleship.glb", Vector3(0, 90, 0), 2.528),
	...
	"Drushi Battleship": ShipConfig.new("Drushi Battleship", "res://glb/Drushi Battleship.glb", Vector3(0, 90, 0), 2.13625),
	"Dwarf Fighter": ShipConfig.new("Dwarf Fighter", "res://glb/Dwarf Fighter.glb", Vector3(0, 90, 0), 0.66),
	"Eclipse Battlleship": ShipConfig.new("Eclipse Battlleship", "res://glb/Eclipse Battlleship.glb", Vector3(0, 90, 0), 2.55),
	...
	"Express Trader": ShipConfig.new("Express Trader", "res://glb/Express Trader.glb", Vector3(0, 90, 0), 1.1),
	...
	"Front Line Cruiser": ShipConfig.new("Front Line Cruiser", "res://glb/Front Line Cruiser.glb", Vector3(0, -90, 0), 2.184),
	"Frostbite Gunship": ShipConfig.new("Frostbite Gunship", "res://glb/Frostbite Gunship.glb", Vector3(0, 90, 0), 1.04),
	"Fury Fighter": ShipConfig.new("Fury Fighter", "res://glb/Fury Fighter.glb", Vector3(0, 90, 0), 0.748),
	...
	"Longhauler Freighter": ShipConfig.new("Longhauler Freighter", "res://glb/Longhauler Freighter.glb", Vector3(0, 90, 0), 1.464),
	...
	"Motorcade Shuttle": ShipConfig.new("Motorcade Shuttle", "res://glb/Motorcade Shuttle.glb", Vector3(0, 90, 0), 0.812),
	"Myrmidon Gunship": ShipConfig.new("Myrmidon Gunship", "res://glb/Myrmidon Gunship.glb", Vector3(0, -90, 0), 1.04),
	"Nebula Battleship": ShipConfig.new("Nebula Battleship", "res://glb/Nebula Battleship.glb", Vector3(0, 90, 0), 2.55),
	"Nexion Cruiser": ShipConfig.new("Nexion Cruiser", "res://glb/Nexion Cruiser.glb", Vector3(0, 270, 0), 1.781),
	...
	"Pikeman Fighter": ShipConfig.new("Pikeman Fighter", "res://glb/Pikeman Fighter.glb", Vector3(0, 90, 0), 0.713),
	...
	"Quadrant Cruiser": ShipConfig.new("Quadrant Cruiser", "res://glb/Quadrant Cruiser.glb", Vector3(0, 90, 0), 1.831),
	...
	"Royal Standard Battleship": ShipConfig.new("Royal Standard Battleship", "res://glb/Royal Standard Battleship.glb", Vector3(0, 90, 0), 2.77),
	...
	"Spike Patrol Ship": ShipConfig.new("Spike Patrol Ship", "res://glb/Spike Patrol Ship.glb", Vector3(0, -90, 0), 1.116),
	"Stalwart Battleship": ShipConfig.new("Stalwart Battleship", "res://glb/Stalwart Battleship.glb", Vector3(0, 90, 0), 2.55),
	...
	"Steadfast Frigate": ShipConfig.new("Steadfast Frigate", "res://glb/Steadfast Frigate.glb", Vector3(0, 90, 0), 1.525),
	...
	"Sunfall Cruiser": ShipConfig.new("Sunfall Cruiser", "res://glb/Sunfall Cruiser.glb", Vector3(0, 90, 0), 2.0),
	...
	"Toad Assault Ship": ShipConfig.new("Toad Assault Ship", "res://glb/Toad Assault Ship.glb", Vector3(0, -90, 0), 1.423),
	...
	"Vector Battleship": ShipConfig.new("Vector Battleship", "res://glb/Vector Battleship.glb", Vector3(0, 90, 0), 2.0),
	...
	"Hedgehog Battleship": ShipConfig.new("Hedgehog Battleship", "res://glb/Hedgehog Battleship.glb", Vector3(0, 90, 0), 2.702),
	...
	"Shield Battleship": ShipConfig.new("Shield Battleship", "res://glb/Shield Battleship.glb", Vector3(0, 90, 0), 2.825),
	...
	"Unyielding Battleship": ShipConfig.new("Unyielding Battleship", "res://glb/Unyielding Battleship.glb", Vector3(0, 0, 0), 2.55),
