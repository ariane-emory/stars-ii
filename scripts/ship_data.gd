...
var ship_configs: Dictionary = {
	"Alpine Cruiser": ShipConfig.new("Alpine Cruiser", "res://glb/Alpine Cruiser.glb", Vector3(0, 0, 0), 2.03359375),
	...
	"Barrier Frigate": ShipConfig.new("Barrier Frigate", "res://glb/Barrier Frigate.glb", Vector3(0, 90, 0), 1.765),
	"Barricade Frigate": ShipConfig.new("Barricade Frigate", "res://glb/Barricade Frigate.glb", Vector3(0, 90, 0), 1.80625),
	"Batwing Gunship": ShipConfig.new("Batwing Gunship", "res://glb/Batwing Gunship.glb", Vector3(0, 90, 0), 0.99),
	"Bearclaw Frigate": ShipConfig.new("Bearclaw Frigate", "res://glb/Bearclaw Frigate.glb", Vector3(0, 90, 0), 1.470875),
	...
	"Brawler Gunship": ShipConfig.new("Brawler Gunship", "res://glb/Brawler Gunship.glb", Vector3(0, 90, 0), 1.045),
	"Brachiator Gun Platform": ShipConfig.new("Brachiator Gun Platform", "res://glb/Brachiator Gun Platform.glb", Vector3(0, 90, 0), 0.99),
	"Breacher Assault Ship": ShipConfig.new("Breacher Assault Ship", "res://glb/Breacher Assault Ship.glb", Vector3(0, 90, 0), 1.30625),
	"Bulwark Battleship": ShipConfig.new("Bulwark Battleship", "res://glb/Bulwark Battleship.glb", Vector3(0, 90, 0), 2.178),
	...
	"Drushi Battleship": ShipConfig.new("Drushi Battleship", "res://glb/Drushi Battleship.glb", Vector3(0, 90, 0), 2.0625),
	"Dwarf Fighter": ShipConfig.new("Dwarf Fighter", "res://glb/Dwarf Fighter.glb", Vector3(0, 90, 0), 0.66),
	"Eclipse Battlleship": ShipConfig.new("Eclipse Battlleship", "res://glb/Eclipse Battlleship.glb", Vector3(0, 90, 0), 2.2),
	...
	"Fortress Cruiser": ShipConfig.new("Fortress Cruiser", "res://glb/Fortress Cruiser.glb", Vector3(0, 90, 0), 1.4915),
	"Front Line Cruiser": ShipConfig.new("Front Line Cruiser", "res://glb/Front Line Cruiser.glb", Vector3(0, -90, 0), 2.03359375),
	...
	"Gattler Frigate": ShipConfig.new("Gattler Frigate", "res://glb/Gattler Frigate.glb", Vector3(0, 90, 0), 1.468),
	"Grasshopper Cruiser": ShipConfig.new("Grasshopper Cruiser", "res://glb/Grasshopper Cruiser.glb", Vector3(0, 90, 0), 2.10),
	...
	"Nexion Cruiser": ShipConfig.new("Nexion Cruiser", "res://glb/Nexion Cruiser.glb", Vector3(0, 90, 0), 1.63065),
	...
	"Pacer Gunship": ShipConfig.new("Pacer Gunship", "res://glb/Pacer Gunship.glb", Vector3(0, 90, 0), 1.089),
	"Paladin Gunship": ShipConfig.new("Paladin Gunship", "res://glb/Paladin Gunship.glb", Vector3(0, 90, 0), 0.9801),
	...
	"Pugilist Patrol Ship": ShipConfig.new("Pugilist Patrol Ship", "res://glb/Pugilist Patrol Ship.glb", Vector3(0, 90, 0), 0.9),
	"Prosperity Trader": ShipConfig.new("Prosperity Trader", "res://glb/Prosperity Trader.glb", Vector3(0, 90, 0), 1.0),
	"Quadrant Cruiser": ShipConfig.new("Quadrant Cruiser", "res://glb/Quadrant Cruiser.glb", Vector3(0, 90, 0), 1.68125),
	"Rack Fighter": ShipConfig.new("Rack Fighter", "res://glb/Rack Fighter.glb", Vector3(0, 90, 0), 0.924),
	...
	"Resolute Frigate": ShipConfig.new("Resolute Frigate", "res://glb/Resolute Frigate.glb", Vector3(0, 90, 0), 1.4625),
	...
	"Royal Standard Battleship": ShipConfig.new("Royal Standard Battleship", "res://glb/Royal Standard Battleship.glb", Vector3(0, 90, 0), 2.42),
	...
	"Secutor Patrol Ship": ShipConfig.new("Secutor Patrol Ship", "res://glb/Secutor Patrol Ship.glb", Vector3(0, 90, 0), 1.21),
	"Shadowblade Fighter": ShipConfig.new("Shadowblade Fighter", "res://glb/Shadowblade Fighter.glb", Vector3(0, 90, 0), 0.8),
	"Shark Gunship": ShipConfig.new("Shark Gunship", "res://glb/Shark Gunship.glb", Vector3(0, 90, 0), 0.9405),
	...
	"Spear Frigate": ShipConfig.new("Spear Frigate", "res://glb/Spear Frigate.glb", Vector3(0, 90, 0), 1.765),
	...
	"Steadfast Frigate": ShipConfig.new("Steadfast Frigate", "res://glb/Steadfast Frigate.glb", Vector3(0, 90, 0), 1.325),
	...
	"Sundown Cruiser": ShipConfig.new("Sundown Cruiser", "res://glb/Sundown Cruiser.glb", Vector3(0, 90, 0), 1.75),
	"Sundiver Frigate": ShipConfig.new("Sundiver Frigate", "res://glb/Sundiver Frigate.glb", Vector3(0, 90, 0), 1.39),
	...
	"Tropica Gunship": ShipConfig.new("Tropica Gunship", "res://glb/Tropica Gunship.glb", Vector3(0, 90, 0), 1.0395),
	"Twinstrike Gunship": ShipConfig.new("Twinstrike Gunship", "res://glb/Twinstrike Gunship.glb", Vector3(0, 90, 0), 1.1),
	...
	"Viking Frigate": ShipConfig.new("Viking Frigate", "res://glb/Viking Frigate.glb", Vector3(0, -90, 0), 1.60),
	...
	"Hedgehog Battleship": ShipConfig.new("Hedgehog Battleship", "res://glb/Hedgehog Battleship.glb", Vector3(0, 90, 0), 2.35224),
	"Infernus Gunship": ShipConfig.new("Infernus Gunship", "res://glb/Infernus Gunship.glb", Vector3(0, 90, 0), 1.045),
