...
var ship_configs: Dictionary = {
	"Alpine Cruiser": ShipConfig.new("Alpine Cruiser", "res://glb/Alpine Cruiser.glb", Vector3(0, 0, 0), 2.18359375),
	"Arsenal Gunship": ShipConfig.new("Arsenal Gunship", "res://glb/Arsenal Gunship.glb", Vector3(0, 90, 0), 1.05),
	...
	"Barricade Frigate": ShipConfig.new("Barricade Frigate", "res://glb/Barricade Frigate.glb", Vector3(0, 90, 0), 1.90625),
	"Batwing Gunship": ShipConfig.new("Batwing Gunship", "res://glb/Batwing Gunship.glb", Vector3(0, 90, 0), 1.04),
	"Bearclaw Frigate": ShipConfig.new("Bearclaw Frigate", "res://glb/Bearclaw Frigate.glb", Vector3(0, 90, 0), 1.570875),
	...
	"Breacher Assault Ship": ShipConfig.new("Breacher Assault Ship", "res://glb/Breacher Assault Ship.glb", Vector3(0, 90, 0), 1.65240625),
	"Bulwark Battleship": ShipConfig.new("Bulwark Battleship", "res://glb/Bulwark Battleship.glb", Vector3(0, 90, 0), 2.378),
	"Carp Trader": ShipConfig.new("Carp Trader", "res://glb/Carp Trader.glb", Vector3(0, 90, 0), 1.21),
	"Cyclops Missile Boat": ShipConfig.new("Cyclops Missile Boat", "res://glb/Cyclops Missile Boat.glb", Vector3(0, 90, 0), 1.21),
	"Dagger Fighter": ShipConfig.new("Dagger Fighter", "res://glb/Dagger Fighter.glb", Vector3(0, 90, 0), 0.72),
	"Darkling Fighter": ShipConfig.new("Darkling Fighter", "res://glb/Darkling Fighter.glb", Vector3(0, 270, 0), 0.756),
	"Dart Scout": ShipConfig.new("Dart Scout", "res://glb/Dart Scout.glb", Vector3(0, 90, 0), 0.8),
	"Dispatch Shuttle": ShipConfig.new("Dispatch Shuttle", "res://glb/Dispatch Shuttle.glb", Vector3(0, 90, 0), 0.76),
	"Dolphin Trader": ShipConfig.new("Dolphin Trader", "res://glb/Dolphin Trader.glb", Vector3(0, 90, 0), 1.0),
	"Drushi Battleship": ShipConfig.new("Drushi Battleship", "res://glb/Drushi Battleship.glb", Vector3(0, 90, 0), 2.03625),
	"Dwarf Fighter": ShipConfig.new("Dwarf Fighter", "res://glb/Dwarf Fighter.glb", Vector3(0, 90, 0), 0.66),
	"Eclipse Battlleship": ShipConfig.new("Eclipse Battlleship", "res://glb/Eclipse Battlleship.glb", Vector3(0, 90, 0), 2.4),
	"Empress Liner": ShipConfig.new("Empress Liner", "res://glb/Empress Liner.glb", Vector3(0, 90, 0), 1.5),
	"Evil Eye Gun Platform": ShipConfig.new("Evil Eye Gun Platform", "res://glb/Evil Eye Gun Platform.glb", Vector3(0, 90, 0), 1.0),
	...
	"Fireball Fighter": ShipConfig.new("Fireball Fighter", "res://glb/Fireball Fighter.glb", Vector3(0, 90, 0), 0.75),
	"Forefront Interceptor": ShipConfig.new("Forefront Interceptor", "res://glb/Forefront Interceptor.glb", Vector3(0, 90, 0), 0.81),
	"Fortress Cruiser": ShipConfig.new("Fortress Cruiser", "res://glb/Fortress Cruiser.glb", Vector3(0, 90, 0), 1.6415),
	"Front Line Cruiser": ShipConfig.new("Front Line Cruiser", "res://glb/Front Line Cruiser.glb", Vector3(0, -90, 0), 2.18359375),
	"Frostbite Gunship": ShipConfig.new("Frostbite Gunship", "res://glb/Frostbite Gunship.glb", Vector3(0, 90, 0), 1.04),
	"Fury Fighter": ShipConfig.new("Fury Fighter", "res://glb/Fury Fighter.glb", Vector3(0, 90, 0), 0.74844),
	"Gattler Frigate": ShipConfig.new("Gattler Frigate", "res://glb/Gattler Frigate.glb", Vector3(0, 90, 0), 1.568),
	"Grasshopper Cruiser": ShipConfig.new("Grasshopper Cruiser", "res://glb/Grasshopper Cruiser.glb", Vector3(0, 90, 0), 2.25),
	...
	"Lineman Hauler": ShipConfig.new("Lineman Hauler", "res://glb/Lineman Hauler.glb", Vector3(0, 90, 0), 1.6),
	"Long Shot Gun Platform": ShipConfig.new("Long Shot Gun Platform", "res://glb/Long Shot Gun Platform.glb", Vector3(0, 90, 0), 1.089),
	"Longhauler Freighter": ShipConfig.new("Longhauler Freighter", "res://glb/Longhauler Freighter.glb", Vector3(0, 90, 0), 1.4641),
	"Longshoreman Hauler": ShipConfig.new("Longshoreman Hauler", "res://glb/Longshoreman Hauler.glb", Vector3(0, 90, 0), 2.16),
	"Luna Shuttle": ShipConfig.new("Luna Shuttle", "res://glb/Luna Shuttle.glb", Vector3(0, 90, 0), 0.76545),
	"Marathon Fighter": ShipConfig.new("Marathon Fighter", "res://glb/Marathon Fighter.glb", Vector3(0, 90, 0), 0.76),
	"Mosquito Fighter": ShipConfig.new("Mosquito Fighter", "res://glb/Mosquito Fighter.glb", Vector3(0, 90, 0), 0.81),
	...
	"Myrmidon Gunship": ShipConfig.new("Myrmidon Gunship", "res://glb/Myrmidon Gunship.glb", Vector3(0, -90, 0), 1.04),
	"Nebula Battleship": ShipConfig.new("Nebula Battleship", "res://glb/Nebula Battleship.glb", Vector3(0, 90, 0), 2.4),
	"Nexion Cruiser": ShipConfig.new("Nexion Cruiser", "res://glb/Nexion Cruiser.glb", Vector3(0, 270, 0), 1.78065),
	"Nightgaunt Gunship": ShipConfig.new("Nightgaunt Gunship", "res://glb/Nightgaunt Gunship.glb", Vector3(0, 90, 0), 1.1),
	...
	"Nova Battleship": ShipConfig.new("Nova Battleship", "res://glb/Nova Battleship.glb", Vector3(0, -90, 0), 1.3),
	...
	"Orca Freighter": ShipConfig.new("Orca Freighter", "res://glb/Orca Freighter.glb", Vector3(0, 90, 0), 1.5),
	"Overlook Gunship": ShipConfig.new("Overlook Gunship", "res://glb/Overlook Gunship.glb", Vector3(0, 90, 0), 0.95),
	"Pacifica Liner": ShipConfig.new("Pacifica Liner", "res://glb/Pacifica Liner.glb", Vector3(0, 90, 0), 1.815),
	"Pacer Gunship": ShipConfig.new("Pacer Gunship", "res://glb/Pacer Gunship.glb", Vector3(0, 90, 0), 1.139),
	"Paladin Gunship": ShipConfig.new("Paladin Gunship", "res://glb/Paladin Gunship.glb", Vector3(0, 90, 0), 1.0301),
	...
	"Pickax Mining Ship": ShipConfig.new("Pickax Mining Ship", "res://glb/Pickax Mining Ship.glb", Vector3(0, 90, 0), 0.9),
	"Pugilist Patrol Ship": ShipConfig.new("Pugilist Patrol Ship", "res://glb/Pugilist Patrol Ship.glb", Vector3(0, 90, 0), 1.09),
	"Prosperity Trader": ShipConfig.new("Prosperity Trader", "res://glb/Prosperity Trader.glb", Vector3(0, 90, 0), 1.0),
	"Quadrant Cruiser": ShipConfig.new("Quadrant Cruiser", "res://glb/Quadrant Cruiser.glb", Vector3(0, 90, 0), 1.83125),

	"Racer Fighter": ShipConfig.new("Racer Fighter", "res://glb/Racer Fighter.glb", Vector3(0, 90, 0), 0.9),
	"Railway Hauler": ShipConfig.new("Railway Hauler", "res://glb/Railway Hauler.glb", Vector3(0, 90, 0), 1.8),
	"Raven Scout": ShipConfig.new("Raven Scout", "res://glb/Raven Scout.glb", Vector3(0, 90, 0), 0.8),
	"Redeye Gun Platform": ShipConfig.new("Redeye Gun Platform", "res://glb/Redeye Gun Platform.glb", Vector3(0, -90, 0), 1.0),
	"Resolute Frigate": ShipConfig.new("Resolute Frigate", "res://glb/Resolute Frigate.glb", Vector3(0, 90, 0), 1.5625),
	"Rimward Freighter": ShipConfig.new("Rimward Freighter", "res://glb/Rimward Freighter.glb", Vector3(0, 90, 0), 0.825),
	"Robin Gunship": ShipConfig.new("Robin Gunship", "res://glb/Robin Gunship.glb", Vector3(0, 90, 0), 1.15),
	"Royal Standard Battleship": ShipConfig.new("Royal Standard Battleship", "res://glb/Royal Standard Battleship.glb", Vector3(0, 90, 0), 2.62),
	"Sai Fighter": ShipConfig.new("Sai Fighter", "res://glb/Sai Fighter.glb", Vector3(0, 90, 0), 0.75),
	"Scarab Construction Ship": ShipConfig.new("Scarab Construction Ship", "res://glb/Scarab Construction Ship.glb", Vector3(0, 90, 0), 1.5),
	...
	"Shark Gunship": ShipConfig.new("Shark Gunship", "res://glb/Shark Gunship.glb", Vector3(0, 90, 0), 0.9905),
	...
	"Spear Frigate": ShipConfig.new("Spear Frigate", "res://glb/Spear Frigate.glb", Vector3(0, 90, 0), 1.865),
	"Spike Patrol Ship": ShipConfig.new("Spike Patrol Ship", "res://glb/Spike Patrol Ship.glb", Vector3(0, -90, 0), 1.1164),
	"Stalwart Battleship": ShipConfig.new("Stalwart Battleship", "res://glb/Stalwart Battleship.glb", Vector3(0, 90, 0), 2.4),
	...
	"Steadfast Frigate": ShipConfig.new("Steadfast Frigate", "res://glb/Steadfast Frigate.glb", Vector3(0, 90, 0), 1.425),
	"Stiletto Fighter": ShipConfig.new("Stiletto Fighter", "res://glb/Stiletto Fighter.glb", Vector3(0, 90, 0), 0.72),
	"Stingray Fighter": ShipConfig.new("Stingray Fighter", "res://glb/Stingray Fighter.glb", Vector3(0, 90, 0), 0.72),
	"Strider Scout": ShipConfig.new("Strider Scout", "res://glb/Strider Scout.glb", Vector3(0, 90, 0), 0.81225),
	"Sundown Cruiser": ShipConfig.new("Sundown Cruiser", "res://glb/Sundown Cruiser.glb", Vector3(0, 90, 0), 1.9),
	"Sundiver Frigate": ShipConfig.new("Sundiver Frigate", "res://glb/Sundiver Frigate.glb", Vector3(0, 90, 0), 1.49),
	"Swordsman Gunship": ShipConfig.new("Swordsman Gunship", "res://glb/Swordsman Gunship.glb", Vector3(0, 90, 0), 1.15),
	"Toad Assault Ship": ShipConfig.new("Toad Assault Ship", "res://glb/Toad Assault Ship.glb", Vector3(0, -90, 0), 1.423125),
	"Tortoise Gunship": ShipConfig.new("Tortoise Gunship", "res://glb/Tortoise Gunship.glb", Vector3(0, 90, 0), 1.15),
	"Tropica Gunship": ShipConfig.new("Tropica Gunship", "res://glb/Tropica Gunship.glb", Vector3(0, 90, 0), 1.0895),
	"Twinstrike Gunship": ShipConfig.new("Twinstrike Gunship", "res://glb/Twinstrike Gunship.glb", Vector3(0, 90, 0), 1.15),
	"Vampire Fighter": ShipConfig.new("Vampire Fighter", "res://glb/Vampire Fighter.glb", Vector3(0, 90, 0), 0.88),
	...
	"Watchman Gunship": ShipConfig.new("Watchman Gunship", "res://glb/Watchman Gunship.glb", Vector3(0, 90, 0), 1.1025),
	"Zephyr Scout": ShipConfig.new("Zephyr Scout", "res://glb/Zephyr Scout.glb", Vector3(0, 90, 0), 0.8),
	"Equinox Battleship": ShipConfig.new("Equinox Battleship", "res://glb/Equinox Battleship.glb", Vector3(0, 90, 0), 1.575),
	"Fleetfoot Scout": ShipConfig.new("Fleetfoot Scout", "res://glb/Fleetfoot Scout.glb", Vector3(0, 90, 0), 0.792),
	"Hedgehog Battleship": ShipConfig.new("Hedgehog Battleship", "res://glb/Hedgehog Battleship.glb", Vector3(0, 90, 0), 2.55224),
	...
	"Sea Turtle Shuttle": ShipConfig.new("Sea Turtle Shuttle", "res://glb/Sea Turtle Shuttle.glb", Vector3(0, -90, 0), 0.684),
	"Shield Battleship": ShipConfig.new("Shield Battleship", "res://glb/Shield Battleship.glb", Vector3(0, 90, 0), 2.675),
	"Snowbird Gunship": ShipConfig.new("Snowbird Gunship", "res://glb/Snowbird Gunship.glb", Vector3(0, 90, 0), 1.15),
	...
	"Unyielding Battleship": ShipConfig.new("Unyielding Battleship", "res://glb/Unyielding Battleship.glb", Vector3(0, 0, 0), 2.4),
	"Valiant Gunship": ShipConfig.new("Valiant Gunship", "res://glb/Valiant Gunship.glb", Vector3(0, 90, 0), 1.144)
}
