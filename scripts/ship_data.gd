...
var ship_configs: Dictionary = {
	...
	"Royal Standard Battleship": ShipConfig.new("Royal Standard Battleship", "res://glb/Royal Standard Battleship.glb", Vector3(0, 90, 0), 2.82),
	...
	"Hedgehog Battleship": ShipConfig.new("Hedgehog Battleship", "res://glb/Hedgehog Battleship.glb", Vector3(0, 90, 0), 2.752),
